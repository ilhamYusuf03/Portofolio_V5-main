...
const WORDS = ["Graduate Informatics Student", "Computer Science"];
const TECH_STACK = ["Python", "TensorFlow", "Javascript", "Machine Learning", 
                  "Pandas", "NumPy", "Scikit-Learn", "Matplotlib", "Seaborn"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/IlhamYusuf03" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/ilham-yusuf-59339b30b/" },
  { icon: Instagram, link: "https://www.instagram.com/_ilhmysf_/?hl=id" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Mengubah data menjadi insight berharga dengan teknologi cerdas dan inovatif.
                </p>
